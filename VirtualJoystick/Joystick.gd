...
signal touch_ended # emitted to catch it in-game (to shoot weapon)
...
func _ready() -> void:
	if not Global.touchControls and visibility_mode == VisibilityMode.TOUCHSCREEN_ONLY:
		hide()
